...
import { CreateUser } from "../service/InvestigatorService";

export default function NewInvestigatorForm({ toggle, setSuccess }) {
    ...
    <>
      <Form onSubmit={handleSubmit}>
        ...
        {isLoading ? (
          ...
          <Alert color="success"> Investigator Created</Alert>
        ) : (
          isError && (
            <div>
